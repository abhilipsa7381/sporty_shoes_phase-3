...
<body style="background-color: lightgreen">
	<br>
	<a href=index.jsp
		style="color: black; text-decoration: none; font-size: 35px; font-weight: bold"><center>SPORTY SHOES-AN E-COMMERCE SITE</center></a>
	<br>
	<br>

	<center>
		<h2 style="color: deepblue">ADMIN LOGIN</h2>
	</center>
	<center>
